...
import { ActionCell } from './UserArchiveCell';
import { RoleCell } from './UserRoleCell';
...
export const createColumns = (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      // Only show the editable dropdown if the user is not archived
      if (showArchived) {
        return (
          <div
      ...
      return <RoleCell row={row} onSuccess={refreshData} />;
    },
...
export const columns: ColumnDef<User>[] = createColumns(false, () => {});
